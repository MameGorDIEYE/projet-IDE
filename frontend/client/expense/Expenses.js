    ...
    return (
      ...
      {expenses.map((expense, index) => {
        ...
        <ExpansionPanel className={classes.panel}>
          ...
          <div>
              <TextField label="Titre" className={classes.textField} value={expense.title} onChange={handleChange('title', index)} margin="normal"/>
             <TextField label="Montant ($)" className={classes.textField} value={expense.amount} onChange={handleChange('amount', index)} margin="normal" type="number"/>
          </div>
          <div>
          <MuiPickersUtilsProvider utils={DateFnsUtils}>
                <DateTimePicker
          ...
          <TextField label="Catégories" className={classes.textField} value={expense.category} onChange={handleChange('category', index)} margin="normal"/>
          </div>
          <TextField
            label="Description"
            multiline
